          ...
          <div className='cat-products-content'>
            ...
            <div className = 'privacycontent'>
              <div className >
                  ...
                  <p>We’ll always keep your data safe and secure. So you’re clued up, here’s why we need it and how we use it.</p>
              </div>
              ...
              <div>
                <h3 className='my-3'>1. THE GOOD STUFF</h3>
                <p>We will only use your data to up your experience.</p>
                <h3 className='my-3'>2. LOCKED DOWN</h3>
                <p>We’ll protect your data like it’s our own.</p>
                <h3 className='my-3'>3. STRAIGHT TALKING</h3>
                <p>We’ll always talk your language and have your back – no-nonsense, no surprises.</p>
                <h3 className='my-3'>4. NO SPAM</h3>
                <p>You decide what and how you hear from us.</p>
                <h3 className='my-3'>5. JUST THE ESSENTIALS</h3>
                <p>Your info won’t just hang about – if we don’t need it, we’ll delete it.</p>
                <h3 className='my-3'>PROTECTING YOUR PRIVACY</h3>
                <p>Pissu Kanna, we are 100% committed to protecting the privacy and security of our customers and site visitors (yep, we mean you). The Pissu Kanna team members are customers themselves, of both Pissu Kanna and other internet sites – so we understand  how important your  privacy is. If you have any questions about how we Protect Your Privacy, drop us a line at hello@pissukanna.com
