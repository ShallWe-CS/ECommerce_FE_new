          ...
          <div className='cart-modal-list grid'>
            {
              carts.map((cart, i) => {
                ...
                return (
                  <div className='cart-modal-item grid align-center font-manrope py-2' key = {i}>
                    <div className='cart-modal-item-img'>
                      <img src = {url} alt = "" className='img-cover' />
                    </div>
                    <div className='cart-modal-item-title fs-13 font-manrope text-capitalize'>{cart[0]?.attributes.product_title}</div>
